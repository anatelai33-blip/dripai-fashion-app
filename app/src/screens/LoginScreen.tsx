        ...
        >
          ...
          <div className="relative inline-block mb-6">
            ...
            <img 
              src="/logo.png" 
              alt="Drip with Mira" 
              className="w-28 h-28 mx-auto rounded-3xl shadow-gold relative z-10 animate-float"
            />
            {/* Glow Ring */}
          ...
          {/* Brand Name */}
          <h1 className="text-5xl font-display font-bold text-gold mb-2 tracking-tight">
            Drip with <span className="text-charcoal">Mira</span>
          </h1>
          
          {/* Tagline */}
          <p className="text-charcoal/50 text-sm font-body tracking-wide uppercase">
